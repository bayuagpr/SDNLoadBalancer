...
class LoadBalancer(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._switch_ip      = usr_config["service_ips"]

        self._servers_ip  = usr_config["server_ips"]
        ...
        for ip_address in self._servers_ip:
            ...
            self.value[ip_address] = 0
            self.weight[ip_address] = w
            w += 2
    ...
    def __get_server_by_type(self, *, service_type) -> "ip_address":
        ...
        self.value[ipserver] = (self.total_connection[ipserver] * 10000) / self.weight[ipserver]
        return ipserver
    ...
    def __multiplexer(self, datapath, input_port, pkt, type_hint) -> None:
        ...
        if type_hint == ether_types.ETH_TYPE_ARP:
            ...
            if ip_src in self._server_ip_mac_mapping:
                ...
                if ip_dst != self._switch_ip:
                    # The packet is not head for the switch
                    # service_type = "red" if ip_src in self._servers_ip else "blue"
                    src_ip  = self._switch_ip
                    dst_ip  = ip_dst
                ...
                src_ip  = ip_src
                dst_ip  = self.__get_server_by_type(service_type="red")
